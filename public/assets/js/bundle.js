...
var GeraCPF = /*#__PURE__*/function () {
  ...
  _createClass(GeraCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var primeiroDigito = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDigito);
      var segundoDigito = _ValidaCPF__WEBPACK_IMPORTED_MODULE_0__["default"].criaDigito(cpfSemDigito + primeiroDigito);
      var novoCPF = cpfSemDigito + primeiroDigito + segundoDigito;
      return this.formataCPF(novoCPF); //console.log(novoCPF);
    }
  }, {
    key: "formataCPF",
...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function geraNovoCPF() {
      ...
      var primeiroDigito = ValidaCPF.criaDigito(cpfParcial);
      var segundoDigito = ValidaCPF.criaDigito(cpfParcial + primeiroDigito);
    ...
    value: function criaDigito(cpfParcial) {
      var cpfParcialArray = Array.from(cpfParcial);
      var soma = ValidaCPF.realizaConta(cpfParcialArray);
      var digito = 11 - soma % 11;
      return digito > 9 ? 0 : digito;
    }
  }, {
    key: "realizaConta",
    value: function realizaConta(cpfParcialArray) {
      var contRegressivo = cpfParcialArray.length + 1;
      var soma = cpfParcialArray.reduce(function (acumulador, valor) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root{\n    --primary-color:rgb(23, 100, 114);\n}\n\n*{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    padding: 0;\n    outline: none;\n    background-color: var(--primary-color);\n    font-family: sans-serif;\n    font-size: 1.3rem;\n    line-height: 1.5;\n}\n\n.container{\n    max-width: 640px;\n    margin: 50px auto;\n    padding: 50px;\n    background-color: rgb(255, 255, 255);\n    border-radius: 20px;\n    box-shadow: 10px 10px 5px gray;\n}\n\n.container h1{\n    text-align: center;\n    margin-bottom: 30px;\n}\n\n.cpf-gerado {\n    font-size: 2em;\n    color: var(--primary-color);\n    text-align: center;\n    font-weight: bold;\n    margin-top: 30px;\n    letter-spacing: 5px;\n}\n\nbutton{\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\nbutton{\n    border: none;\n    border-radius: 30px;\n    height: 50px;\n    font-size: 18px;\n    font-weight: 700;\n    background-color: var(--primary-color);\n    color: white;\n    cursor: pointer;\n    transition: all 300ms ease-in-out;\n    margin-top: 30px;\n}\n\nbutton:hover{\n    color:  var(--primary-color);\n    background-color: white;\n}\n", "",{"version":3,"sources":["webpack://./src/assets/css/styles.css"],"names":[],"mappings":"AAAA;IACI,iCAAiC;AACrC;;AAEA;IACI,SAAS;IACT,sBAAsB;AAC1B;;AAEA;IACI,UAAU;IACV,aAAa;IACb,sCAAsC;IACtC,uBAAuB;IACvB,iBAAiB;IACjB,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,iBAAiB;IACjB,aAAa;IACb,oCAAoC;IACpC,mBAAmB;IACnB,8BAA8B;AAClC;;AAEA;IACI,kBAAkB;IAClB,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,2BAA2B;IAC3B,kBAAkB;IAClB,iBAAiB;IACjB,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,cAAc;IACd,WAAW;IACX,mBAAmB;AACvB;;AAEA;IACI,YAAY;IACZ,mBAAmB;IACnB,YAAY;IACZ,eAAe;IACf,gBAAgB;IAChB,sCAAsC;IACtC,YAAY;IACZ,eAAe;IACf,iCAAiC;IACjC,gBAAgB;AACpB;;AAEA;IACI,4BAA4B;IAC5B,uBAAuB;AAC3B","sourcesContent":[":root{\n    --primary-color:rgb(23, 100, 114);\n}\n\n*{\n    margin: 0;\n    box-sizing: border-box;\n}\n\nbody{\n    padding: 0;\n    outline: none;\n    background-color: var(--primary-color);\n    font-family: sans-serif;\n    font-size: 1.3rem;\n    line-height: 1.5;\n}\n\n.container{\n    max-width: 640px;\n    margin: 50px auto;\n    padding: 50px;\n    background-color: rgb(255, 255, 255);\n    border-radius: 20px;\n    box-shadow: 10px 10px 5px gray;\n}\n\n.container h1{\n    text-align: center;\n    margin-bottom: 30px;\n}\n\n.cpf-gerado {\n    font-size: 2em;\n    color: var(--primary-color);\n    text-align: center;\n    font-weight: bold;\n    margin-top: 30px;\n    letter-spacing: 5px;\n}\n\nbutton{\n    display: block;\n    width: 100%;\n    margin-bottom: 10px;\n}\n\nbutton{\n    border: none;\n    border-radius: 30px;\n    height: 50px;\n    font-size: 18px;\n    font-weight: 700;\n    background-color: var(--primary-color);\n    color: white;\n    cursor: pointer;\n    transition: all 300ms ease-in-out;\n    margin-top: 30px;\n}\n\nbutton:hover{\n    color:  var(--primary-color);\n    background-color: white;\n}\n"],"sourceRoot":""}]);
// Exports
...
(function () {
  ...
  document.addEventListener('click', function (event) {
    ...
    if (elemento.classList.contains('btn-gerar')) {
      var _iterator = _createForOfIteratorHelper(document.querySelectorAll('.cpf-gerado')),
          _step;

      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var cpfText = _step.value;
          cpfText.remove();
        }
      } catch (err) {
        _iterator.e(err);
  ...
  function mostraValor(div) {
    var novoCPF = new _modules_GeraCPF__WEBPACK_IMPORTED_MODULE_0__["default"]();
